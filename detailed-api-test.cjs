...
async function testHealthCheck() {
  ...
  try {
    ...
    logTest('健康检查', response.status === 200 && response.data.status === 'ok', '', response);
  } catch (error) {
...
async function testBooksAPI() {
  ...
  try {
    ...
    logTest('获取图书列表', response.status === 200 && Array.isArray(response.data), '', response);
  } catch (error) {
  ...
  if (bookId) {
    try {
      ...
      logTest('获取图书详情', response.status === 200 && response.data.id === bookId, '', response);
    } catch (error) {
    ...
    try {
      ...
      logTest('更新图书', response.status === 200, '', response);
    } catch (error) {
    ...
    try {
      ...
      logTest('删除图书', response.status === 200, '', response);
    } catch (error) {
  ...
  try {
    ...
    logTest('搜索图书', response.status === 200 && Array.isArray(response.data), '', response);
  } catch (error) {
...
async function testCategoriesAPI() {
  ...
  try {
    ...
    logTest('获取分类列表', response.status === 200 && Array.isArray(response.data), '', response);
  } catch (error) {
  ...
  if (categoryId) {
    try {
      ...
      logTest('更新分类', response.status === 200, '', response);
    } catch (error) {
    ...
    try {
      ...
      logTest('删除分类', response.status === 200, '', response);
    } catch (error) {
...
async function testBorrowsAPI() {
  ...
  try {
    ...
    logTest('获取借阅记录', response.status === 200 && Array.isArray(response.data), '', response);
  } catch (error) {
  ...
  try {
    ...
    logTest('获取即将到期借阅', response.status === 200 && Array.isArray(response.data), '', response);
  } catch (error) {
  ...
  try {
    ...
    logTest('获取最近活动', response.status === 200 && Array.isArray(response.data), '', response);
  } catch (error) {
...
async function testStatisticsAPI() {
  ...
  try {
    ...
    logTest('获取概览统计', response.status === 200 && typeof response.data === 'object', '', response);
  } catch (error) {
  ...
  try {
    ...
    logTest('获取月度统计', response.status === 200 && Array.isArray(response.data), '', response);
  } catch (error) {
  ...
  try {
    ...
    logTest('获取分类统计', response.status === 200 && Array.isArray(response.data), '', response);
  } catch (error) {
...
async function testSettingsAPI() {
  ...
  try {
    ...
    logTest('获取设置', response.status === 200 && Array.isArray(response.data), '', response);
  } catch (error) {
  ...
  try {
    ...
    logTest('更新设置', response.status === 200, '', response);
  } catch (error) {
...
async function runAllTests() {
  ...
  console.log('\n📄 详细测试报告已保存到: detailed-api-test-report.json');
